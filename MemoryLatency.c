...
int default_test_sizes[] = { 5120, 6144, 8192, 10240, 12288, 13312, 14336, 15360, 16384, 18432, 20480, 24567, 32768, 65536, 98304,
...
int main(int argc, char* argv[]) {
    #pragma omp parallel num_threads(1)
    {
        ...
        if (argc == 1) {
            if (threadId == 0) fprintf(stderr, "Usage: [-test <c/asm/tlb/mlp>] [-maxsizemb <max test size in MB>] [-iter <base iterations, default 100000000]\n");
        }
